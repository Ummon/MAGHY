...
% that ends a line with a % and d§o not let a space in before the next \thanks.
...
* implémenter ce qui est vraiment nécessaire, ne pas se perdre
* définir en premier ce que l'on veut (le quoi) et pas comment on va le réaliser (le comment)
