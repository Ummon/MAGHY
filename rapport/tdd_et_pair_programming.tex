...
\begin{table*}[!t]
\begin{center}
    \caption{Tableau de comparaison du pair programming contre des développeurs seuls\cite[p.~71]{PPLaurie}}
    \label{table_example}
    \begin{tabular}{| l | l | l|}
    \hline
...
\bibitem{PPping}
Example d'un pattern en pair programming, 04.05.2015, URL:
\ttfamily{http://c2.com/cgi/wiki?PairProgrammingPingPongPattern}

\bibitem{PPLaurie}
Laurie Ann Williams \emph{The collaborative software process}, Department of Computer Science University of Utah , Août 2000.

\bibitem{PPMatrix}
Exemple de matrices pour le pair programming , 04.05.2015, URL: \ttfamily{ blog.pivotal.io/pivotal-labs/labs/pair-programming-matrix}

\bibitem{PPIde1}
Hitch est un logiciel pour faire du pair programming avec Git, 04.05.2015, URL: \ttfamily{ https://github.com/therubymug/hitch}
\bibitem{PPIde2}
Git-pairing est un logiciel pour faire du pair programming avec Git, 04.05.2015, URL:
\ttfamily{ https://github.com/glg/git-pairing}
\bibitem{PPEtude}
Étude concernant le pair programming dans des universités américaines, 04.05.2015, URL:\ttfamily{ http://www.realsearchgroup.org/pairlearning/index.php etudes}
\bibitem{PPGril}
Vidéo d'écolières explicant le pair programming, 04.05.2015, URL:\ttfamily{ https://www.youtube.com/watch?v=vgkahOzFH2Q}
\bibitem{PPBarak}
Vidéo de code.org pour promouvoir le pair programming via des célébrités., 04.05.2015, URL:\ttfamily{ https://www.youtube.com/watch?v=FC5FbmsH4fw}
